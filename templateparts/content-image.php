...
/**
 *
 *  The template for portfolio image format.
 *
...
<div class="blog-image-container-default blog-container" >
  <div class="row">
    <div class="col-lg-5 col-5 col-sm-6 col-12">
      <div class="image-block background-image" style="background-image:url('<?php echo esc_attr( get_the_post_thumbnail_url() ); ?>')">
        ...
        <div class="icon-default-container">
          <div class="icon-default background-image" style="background-image:url('<?php echo esc_attr(get_template_directory_uri() . '/img/picture.png'); ?>')">
    ...
    <div class="col-lg-7 col-7 col-sm-6 col-12">
