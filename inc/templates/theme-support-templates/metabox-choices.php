...
<?php
  for ( $i = 0; $i < $value ; $i++ ){
    ...
    ?>
    <label id="lnumber<?php echo intval( $i ); ?>" for="number<?php echo intval( $i ); ?>" ><?php  echo esc_html( __( 'Choose the name of the detail' , 'simplePortfolio' ) ); ?> </label>
    ...
    <label id="lanswer<?php echo intval( $i ); ?>" for="answer<?php echo intval( $i ); ?>" ><?php echo  esc_html( __( 'Choose the value of the detail' , 'simplePortfolio' ) ); ?></label>
    ...
    <button id="button<?php echo intval( $i ); ?>" class="add-choices-state button button-primary"><?php echo esc_html( __( 'Remove detail' , 'simplePortfolio' ) ); ?></button><br class="br<?php echo intval( $i ); ?>"></br><br class="br<?php echo intval( $i ); ?>"></br>
